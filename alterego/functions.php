...
function alterego_scripts() {
	...
	wp_enqueue_style( 'alterego-tachyons', get_template_directory_uri() . 
	'/css/tachyons.css');

	wp_enqueue_style( 'alterego-fonts', get_template_directory_uri() . 
	'/css/fonts.css');

	wp_enqueue_style( 'alterego-custom', get_template_directory_uri() . 
	'/css/custom.css');

	wp_style_add_data( 'alterego-style', 'rtl', 'replace' );

	
	wp_enqueue_script( 'alterego-marquee', get_template_directory_uri() . 
	'/js/marquee.js ');
